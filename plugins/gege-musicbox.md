...
| 我喜欢 | 爱心收藏；需 oxmysql |
| 悬浮歌词 | 屏幕固定位置与字号；听距内显示；转视角不跟着晃；播放器「词」可开关 |
| 多人同步听歌 | xsound；须完成去墙 |
...
| `screenX` | 屏幕横向位置（0 左 1 右，默认 0.72 偏右） |
| `screenY` | 屏幕纵向位置（0 顶 1 底，默认 0.52） |
